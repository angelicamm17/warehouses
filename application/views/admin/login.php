		...
		<div class="page-content vertical-align-middle">
			...
			<form method="post" action="<?php echo site_url();?>login/ceklogin" name="formLogin" id="form" parsley-validate novalidate>
				...
				<div class="form-group">
					...
					<input type="text" required class="form-control" name="username" autofocus id="user" placeholder="Nombre de usuario">
				</div>
				<div class="form-group">
				...
				<div class="signup"><button type="submit" class="btn btn-info rounded-0" name="masuk">Iniciar sesión</button></div>
			</form>
