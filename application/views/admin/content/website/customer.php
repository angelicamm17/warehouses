	                        ...
	                        if ($jml_data > 0){
	                            ...
	                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <b>Creado:</b> <?php echo dateIndo($row->customer_created);?><br>
                                                <b>Última actualización</b> <?php echo dateIndo($row->customer_updated);?>
                                </td>
                            <?php if ($admin->admin_level_kode == 1) { ?>
                                            <td class="text-center action">
                                                ...
                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_customer;?>" data-toggle="modal" data-target="#modal-konfirmasi"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="javascript:;" class="btn btn-danger" id="hapus-customer">Sí</a>
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>website/customer/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                            <div class="form-group form-material">
                                ...
                                <input type="text" class="form-control input-sm" id="nama_customer" name="nama_customer" placeholder="Nombre del cliente" required/>
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Dirección</label>
                                <input type="text" class="form-control input-sm" id="alamat_customer" name="alamat_customer" placeholder="Dirección" required/>
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Número de teléfono</label>
                                <input type="text" class="form-control input-sm" id="notelp_customer" name="notelp_customer" placeholder="Número de teléfono" required/>
                            </div>
                            <div class='button center'>
                                <input class="btn btn-success btn-sm" type="submit" name="simpan" value="Añadir datos" id="validateButton2">
                                <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/customer'"
                                />
                            </div>
                        </form>
                    </div>
                ...
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>website/customer/edit/<?php echo $id_customer;?>" method="post" id="exampleStandardForm" autocomplete="off">
                            ...
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Nombre del cliemte</label>
