...
<div class="page">
	<div class="page-title orange">
		...
		<p>Información sobre la <!--Information About-->
			<?php echo $breadcrumb; ?>
		</p>
	</div>
			...
			<div class="col-md-12">
				<div class="panel rounded-0">
					<div class="panel-heading">
						<h5 class="panel-title">Notificaciones de Existencias con Edición Mínima</h5> <!--Minimal Edit Stock Notifications-->
					</div>
					<!-- ========== Flashdata ========== -->
					...
					<div class="panel-body container-fluid">
						...
						id="exampleStandardForm" autocomplete="off">
							...
							<div class="form-group form-material">
								...
								<input type="number" class="form-control input-sm" id="stock" name="stock" placeholder="Enter Stock"
								value="<?php echo $stock;?>" required />
							</div>
							<div class="form-group form-material">
								<label class="control-label" for="inputText">Creado</label> <!--Created-->
							...
							<div class="form-group form-material">
								<label class="control-label" for="inputText">Último cambio</label> <!--Last Changed-->
