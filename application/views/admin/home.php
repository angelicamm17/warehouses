...
<body>
					...
					<ul class="site-menu">
						...
						<li class='site-menu-item has-sub'>
							<a href='javascript:void(0)' class='animsition-link'>
								...
								<span class='site-menu-title'>Transacción</span> <!--Transaction-->
							</a>
						...
						<li class='site-menu-item has-sub'>
							<a href='javascript:void(0)' class='animsition-link'>
								...
								<span class='site-menu-title'>Lista maestra</span> <!--Master List-->
							</a>
							<ul class='site-menu-sub'>
								<?php if($admin->admin_level_kode === '1' || $admin->admin_level_kode === '2') {?>
								<li class='site-menu-item'>
	...
	<script>
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-transport').attr("href", "<?php echo site_url();?>website/transport/");
		});
	</script>
